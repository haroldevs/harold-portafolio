    ...
    <section id="contact" className="py-48">
      ...
      <div className="md:flex md:justify-between gap-16 mt-5">
        ...
        >
          ...
          >
            <input
              className="w-full bg-gray-600 font-semibold placeholder-opaque-black p-3"
              type="text"
            ...
            <input
              className="w-full bg-gray-600 font-semibold placeholder-opaque-black p-3 mt-5"
              type="text"
            ...
            {errors.message && (
              <p className="text-red mt-1">
                ...
                {errors.message.type === "message" && "Max Length is 2000 char"}
              </p>
            )}
